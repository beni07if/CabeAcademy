            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create Account ID Academy</h5>
                  </div>
...
<div class="col-12">
    ...
    <input type="text" name="unit_id" class="form-control" id="unitID" required>
    <div class="invalid-feedback">Please, enter the unit ID!</div>
</div>
...
<div class="col-12 mt-4">
    <button class="ml-4 btn btn-primary" type="submit">Register</button>
</div>
